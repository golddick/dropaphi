...
class EmailSenderService {
  ...
  async sendEmail(options: EmailOptions): Promise<EmailResult> {
    ...
    const domain = process.env.NEXT_PUBLIC_APP_URL || "https://dropaphi.vercel.app";
    ...
    try {
      ...
      const mailOptions: nodemailer.SendMailOptions = {
        ...
        headers: {
          ...headers,
          "X-Mailer": "DropAphi",
          "List-Unsubscribe": `<${domain}/api/unsubscribe?email=${encodeURIComponent(recipients)}>`,
        },
      };
...
//     const domain =
//       process.env.NEXT_PUBLIC_APP_URL || "https://dropaphi.vercel.app";
...
//           /href="([^"]+)"/g,
//           (_, url) =>
//             `href="${domain}/api/email/track/click?emailId=${emailId}&email=${encodeURIComponent(
//               recipients
//             )}&url=${encodeURIComponent(url)}"`
//         );
//       }
...
//       // -------------------------
//       if (emailId) {
//         enhancedHTML += `<img src="${domain}/api/email/track/open?emailId=${emailId}&email=${encodeURIComponent(
//           recipients
//         )}" width="1" height="1" style="display:none;" />`;
//       }
...
//       // -------------------------
//       const mailOptions: nodemailer.SendMailOptions = {
//         from: fromName ? `"${fromName}" <${process.env.SMTP_USER}>`: 'noreply@thenews.africa',
//         to: recipients,
//         bcc,
//         cc,
//         subject,
