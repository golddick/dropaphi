...
const SECTIONS = [
  {
    ...
    content: `DropAPHI ("we", "us", "our") operates the DropAPHI website and platform. This Privacy Policy outlines how we collect, use, disclose, and protect your personal information when you use our services. By using Drop APHI you consent to the practices described here.`,
    list: null,
  },
  {
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <motion.div initial={{ opacity: 0, y: 28 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <div className="mt-6 flex items-center gap-4">
              <span className="font-mono text-xs text-muted-foreground px-3 py-1 rounded-md bg-[#161616] border border-border">
          ...
          >
            ...
            <div className="flex gap-4 flex-wrap">
              <div className="bg-[#141414] border border-[#222] rounded-lg p-3.5 px-5">
                ...
                <p className="font-['Plus_Jakarta_Sans'] text-sm text-white">privacy@dropaphi.xyz</p>
              </div>
              <div className="bg-[#141414] border border-[#222] rounded-lg p-3.5 px-5">
