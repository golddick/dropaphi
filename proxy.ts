...
export async function proxy(request: NextRequest) {
  ...
  // console.log("Has access token:", !!request.cookies.get(ACCESS_COOKIE));
  // console.log("Has refresh token:", !!request.cookies.get(REFRESH_COOKIE));
  ...
  if (
    ...
    // console.log("Static file, allowing");
  ...
  if (hasAccessToken || hasRefreshToken) {
    console.log("Has auth token, allowing");
    return NextResponse.next();
  }

  // Redirect to login
  // console.log(`No auth, redirecting from ${pathname} to /auth/login`);
